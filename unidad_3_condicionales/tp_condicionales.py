...
numero = int(input("Ingrese un numero solo pares: "))
if numero %2 == 0:
    print("Ha igresado un numero par")
else:
    print("Ingrese solo numeros pares")     
...
opcion = int(input("Ingrese una opción (1 para mayúsculas, 2 para minúsculas, 3 para primera letra mayúscula): "))
...
if opcion == 1:
    ...
    nombre_modificado = "Opción inválida"

print("El nombre modificado es:", nombre_modificado)
